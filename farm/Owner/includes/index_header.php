		...
		<div class="container" id="header2">
          <div class="navbar-header">
				<a class="navbar-brand home" href="index.php">
					<img src="img/new1.png" alt="Shop" class="hidden-xs">
					   <img src="img/new1.png" alt="Shop" class="visible-xs">
                  </div>
                  <div id="title">
				...
				if(isset($_SESSION['login_user']))
				{
					...
					?>
						...
						<li class="active"><i class="fa fa-user fa-2x">
							<a href="admin_profile.php" id=""><?php echo $_SESSION['login_user']; ?></a>
						</i></li>
						<li class="active"><i class="fa fa-sign-out fa-2x">
							<a href="includes/logout.php" id="">Logout</a>
						</i></li>
