	...
	alert("incorrect username or password");
			...
			<?php	
				...
				else
				{
					...
					?>
			<script type="text/javascript">
	window.location="customer/specialoffer.php"
</script>
			<?php		
				}
			}
			...
			?>
			<script type="text/javascript">
	window.location="owner/specialoffer.php"
</script>		
