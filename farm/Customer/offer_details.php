			...
			<div class="row" id="productmain">
				...
				<div class="col-sm-6">  <!-- col-sm-6 starts -->
					<div class="box">
						...
						<form action="offer_details.php?add_cart=<?php echo $Fid;?>" method="post" class="form-horizontal">
							<div class="form-group">  <!-- form group  starts -->
								<label class="col-md-5 control-label"><label>Quantity(kg.): </label></label>
								<div class="col-md-7">
									<input type="number" name="quantity" value="10" readonly>
								</div>
						...
						<?php
						$Fid=mysqli_query($db,"select Fid from food where Fname='$foodname'");
						add_cart();
